...
import { getRouteAsRouteObj, goToRoute,  NETWORK} from "../route-link-names";
import {prepareRouteAnimation } from "../route-animation";

@Component({
  selector: 'app-sub-network',
  templateUrl: './sub-network.component.html',
  styleUrls: ['./sub-network.component.css']
})
export class SubNetworkComponent {
