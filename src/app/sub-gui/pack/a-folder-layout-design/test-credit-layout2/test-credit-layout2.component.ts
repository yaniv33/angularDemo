...
@Component({
  selector: 'app-test-credit-layout2',
  templateUrl: './test-credit-layout2.component.html',
  styleUrls: ['./test-credit-layout2.component.scss'],
  encapsulation: ViewEncapsulation.None // must add this so mat field would notice scss
})
export class TestCreditLayout2Component implements OnInit {
  ...
  onAddCreditCardPressed() {
    ...
    console.log(this.creditCardPaymentHolder)
  }
